...
def test_process_mail_survives_wecom_notification_failure(
    tmp_path,
    monkeypatch,
):
    import run_foreign_trade_agent as runner
    ...
    fake_mail = SimpleNamespace(
        sender="Lucas Silva <lucas@example.com>",
        subject="RFQ for Model R2",
        date="Fri, 12 Sep 2026 18:00:00 +0800",
        body="Customer inquiry",
        message_id="<wecom-failure@example.com>",
    )
